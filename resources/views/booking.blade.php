                ...
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
                    ...
                    <div class="mt-4 space-y-3">
                        <label class="flex items-center justify-between p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                            <div class="flex items-center">
                                <input name="payment_method" form="booking-form" type="radio" value="transfer" class="h-4 w-4 text-primary-600" {{ old('payment_method') == 'transfer' ? 'checked' : '' }} required>
                        ...
                        <label class="flex items-center justify-between p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                            <div class="flex items-center">
                                <input name="payment_method" form="booking-form" type="radio" value="ewallet" class="h-4 w-4 text-primary-600" {{ old('payment_method') == 'ewallet' ? 'checked' : '' }} required>
